...
export const defaultSettings: Settings = { serverUrl: 'http://10.0.2.2:5080', token: null, userName: null, deviceId: null, readerKind: 'simulated', currentLocationId: null, currentLocationName: null, power: 30, beep: true };
