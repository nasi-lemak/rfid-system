  ...
  return (
    <div className="app">
      <aside className="sidebar">
        ...
        <div className="user">{user?.displayName}<br /><span className="muted">{user?.role} · {user?.tenantName ?? 'tenant'}</span></div>
