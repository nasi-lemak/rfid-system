...
const groups: { title: string; links: { to: string; label: string; admin?: boolean }[] }[] = [
  ...
  { title: 'Track', links: [{ to: '/items', label: 'Items' }, { to: '/tags', label: 'Tags' }, { to: '/operations', label: 'Operations' }, { to: '/stocktakes', label: 'Stocktakes' }, { to: '/print-queue', label: 'Print queue' }, { to: '/encoding', label: 'Encoding' }] },
  { title: 'Configure', links: [{ to: '/item-types', label: 'Item types' }, { to: '/locations', label: 'Locations' }, { to: '/parties', label: 'Parties' }, { to: '/devices', label: 'Readers & devices' }, { to: '/rules', label: 'Rules' }, { to: '/notifications', label: 'Notifications', admin: true }, { to: '/labels', label: 'Label designer' }, { to: '/templates', label: 'Solution templates' }, { to: '/integrations', label: 'Integrations', admin: true }, { to: '/import', label: 'ERP import', admin: true }, { to: '/users', label: 'Users', admin: true }, { to: '/cluster', label: 'Cluster & system', admin: true }, { to: '/audit', label: 'Audit & retention', admin: true }] },
];
