...
const groups: { title: string; links: { to: string; label: string; admin?: boolean }[] }[] = [
  ...
  { title: 'Track', links: [{ to: '/items', label: 'Items' }, { to: '/tags', label: 'Tags' }, { to: '/operations', label: 'Operations' }, { to: '/stocktakes', label: 'Stocktakes' }, { to: '/stock', label: 'Stock' }, { to: '/print-queue', label: 'Print queue' }, { to: '/encoding', label: 'Encoding' }, { to: '/billing', label: 'Billing' }, { to: '/maintenance', label: 'Maintenance' }] },
