...
export interface Rule { id: Guid; name: string; enabled: boolean; kind?: 'Event' | 'Schedule'; trigger: string; intervalMinutes?: number; lastRunAt?: string | null; conditions: RuleCondition[]; action: string; params: Record<string, unknown>; severity: string; vertical?: string | null; notifyChannelIds?: Guid[]; escalationPolicyId?: Guid | null }

export interface OperationSummary { id: Guid; type: string; definitionCode?: string | null; workflowRunId?: string | null; workflowCode?: string | null; workflowStep?: string | null; status: string; fromLocation?: string | null; toLocation?: string | null; party?: string | null; targetState?: string | null; reference?: string | null; notes?: string | null; user?: string | null; startedAt: string; completedAt?: string | null; lineCount: number; ok: number; rejected: number; unknown: number }
...
export interface WorkflowStep { key: string; title: string; prompt?: string | null; operation: string; ask: string[]; fixed: { toLocationId?: Guid | null; partyId?: Guid | null; targetState?: string | null; containerItemId?: Guid | null; reference?: string | null }; rescan: boolean; optional: boolean; onRejected: 'stop' | 'continue' }
export interface WorkflowDefinition { id: Guid; code: string; name: string; description: string; enabled: boolean; vertical?: string | null; icon?: string | null; itemTypeCodes: string[]; steps: WorkflowStep[] }
export interface WorkflowRunSummary { runId: string; workflowCode?: string | null; workflowName?: string | null; startedAt: string; lastActivityAt: string; stepsDone: number; stepsTotal: number; ok: number; rejected: number; unknown: number; userId?: Guid | null; deviceId?: Guid | null; lastStep: string; completed: boolean }
export interface StockBalance { itemTypeId: Guid; itemType: string; itemTypeCode: string; locationId?: Guid | null; location?: string | null; lotNumber?: string | null; expiry?: string | null; quantity: number; unit?: string | null; rows: number; lastSeenAt?: string | null }
export interface StockSummary { itemTypeId: Guid; itemType: string; itemTypeCode: string; onHand: number; unit?: string | null; locations: number; lots: number; reorderPoint?: number | null; shortfall: number; consumed30d: number; daysOfCover?: number | null; earliestExpiry?: string | null; expiringSoon: number }
export interface StockMovement { at: string; itemId: Guid; identifier: string; itemType: string; lotNumber?: string | null; delta: number; before?: number | null; locationId?: Guid | null; location?: string | null; kind: string; operationId?: Guid | null }
export interface StockPick { itemId: Guid; identifier: string; epc?: string | null; locationId?: Guid | null; location?: string | null; lotNumber?: string | null; expiry?: string | null; available: number; take: number }
export interface StockAllocation { itemType: string; itemTypeCode: string; requested: number; allocated: number; shortfall: number; picks: StockPick[] }
...
export interface Lookups { operationTypes: string[]; ruleKinds?: string[]; locationKinds: string[]; partyKinds: string[]; deviceKinds: string[]; tagTechnologies: string[]; eventTypes: string[]; ruleActions: string[]; severities: string[]; itemStatuses: string[]; ruleFields: string[]; ruleOps: string[] }
