...
const dict: Record<Lang, Record<string, string>> = {
  en: {},
  ms: {
    'Dashboard': 'Papan pemuka', 'Live reads': 'Bacaan langsung', 'Alerts': 'Amaran', 'Presence & location': 'Kehadiran & lokasi', 'Map & geofences': 'Peta & geopagar', 'Event log': 'Log peristiwa', 'Reports': 'Laporan', 'Analytics': 'Analitik', 'Anomalies': 'Anomali',
  ...
  zh: {
    'Dashboard': '仪表盘', 'Live reads': '实时读取', 'Alerts': '告警', 'Presence & location': '在场与位置', 'Map & geofences': '地图与围栏', 'Event log': '事件日志', 'Reports': '报表', 'Analytics': '分析', 'Anomalies': '异常',
  ...
  es: {
    'Dashboard': 'Panel', 'Live reads': 'Lecturas en vivo', 'Alerts': 'Alertas', 'Presence & location': 'Presencia y ubicación', 'Map & geofences': 'Mapa y geocercas', 'Event log': 'Registro de eventos', 'Reports': 'Informes', 'Analytics': 'Analítica', 'Anomalies': 'Anomalías',
  ...
  de: {
    'Dashboard': 'Übersicht', 'Live reads': 'Live-Lesungen', 'Alerts': 'Alarme', 'Presence & location': 'Präsenz & Ort', 'Map & geofences': 'Karte & Geofences', 'Event log': 'Ereignisprotokoll', 'Reports': 'Berichte', 'Analytics': 'Analysen', 'Anomalies': 'Anomalien',
  ...
  fr: {
    'Dashboard': 'Tableau de bord', 'Live reads': 'Lectures en direct', 'Alerts': 'Alertes', 'Presence & location': 'Présence et localisation', 'Map & geofences': 'Carte et géorepères', 'Event log': "Journal d'événements", 'Reports': 'Rapports', 'Analytics': 'Analytique', 'Anomalies': 'Anomalies',
